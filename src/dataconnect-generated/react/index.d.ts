...
export function useClearRecentUserMoods(options?: useDataConnectMutationOptions<ClearRecentUserMoodsData, FirebaseError, ClearRecentUserMoodsVariables>): UseDataConnectMutationResult<ClearRecentUserMoodsData, ClearRecentUserMoodsVariables>;
export function useClearRecentUserMoods(dc: DataConnect, options?: useDataConnectMutationOptions<ClearRecentUserMoodsData, FirebaseError, ClearRecentUserMoodsVariables>): UseDataConnectMutationResult<ClearRecentUserMoodsData, ClearRecentUserMoodsVariables>;
